...
class RenderKnitMeshNetwork(component):
    ...
    def RunScript(self, KMN, RenderNodes, RenderNodeIndices, RenderNodeData, NodeTextPlane, NodeTextHeight, RenderContourEdges, RenderContourEdgeData, RenderWeftEdges, RenderWeftEdgeData, RenderWarpEdges, RenderWarpEdgeData, EdgeTextHeight, EdgeTextPlane):
